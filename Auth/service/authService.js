...
const Register = async(avatarfile , userData,res)=>{
    ...
    const newUser = {
        ...
        email,
        password : hash_pass,
        avatar : avatarfile ? avatarfile.base64 : "data:image/jpeg;base64,/9j/4AAQSkZJRgABAQEASABIAAD/2wBDAP//////////////////////////////////////////////////////////////////////////////////////wgALCAABAAEBAREA/8QAFBABAAAAAAAAAAAAAAAAAAAAAP/aAAgBAQABPwA=",
        phone,
        city,
        flat,
        street,
